...
Its security goals mainly evolve around confidentiality, integrity, and authentication of message (or patch) sources.
...
\begin{table}[h]
    ...
    \hline
    \multirow{4}{*}{Authentication}            & Aliveness                    &       &                    & \checkmark                        & \checkmark                          \\
                                               & Weak agreement               &       &                    & \checkmark                        &                            \\
                                               & Non-injective agreement      &       &                    & \checkmark                        &                            \\
                                               & Injective agreement          & $\bullet$     &                    & \checkmark                        & \checkmark                          \\
    \hline
    \multirow{4}{*}{\begin{tabular}[c]{@{}l@{}}Observational \\equivalence \end{tabular}} & Strong secrecy               &      &                    &                        & \checkmark                          \\
...
Since the \gls{3gpp} specification does not explicitly mention any observational equivalence requirements, any security property that can be proven in this category is considered \textit{nice to have}.
However, as noted before, \textsc{ProVerif} does offer finer control over the type of observational equivalence to be verified.

It is the additional features of \textsc{ProVerif} that can help modeling the protocol more closely aligned to the \gls{3gpp} specification.
