...
\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
    ...
    \sgoal{
        Security property 6: Information in the \textit{dataToIntegrityProtect} object shall be integrity protected. (c.f. \cite{3gpp.33.501}, p. 135)
    }
    \sgoal{
        Security property 7: Information in the \textit{dataToIntegrityProtectAndCipher} object shall be confidentiality and integrity protected. (c.f. \cite{3gpp.33.501}, p. 135)
    }
    ...
    \sgoal{
        Security property 8: Intermediaries in the path shall not be able to remove message modifications previously added by \gls{ipx} providers. (c.f. \cite{3gpp.33.501}, p. 135)
    }
    ...
    \asgoal{
        Security property 11: The source of N32-f messages shall be authenticated by the receiving \gls{sepp}.
    }
    ...
    \sgoal{
        Security property 12: Only IPX providers referenced in one of the \gls{sepp} operator's IPX security information lists shall be able to perform message modifications. (c.f. \cite{3gpp.33.501}, p. 127)
    }
    \sgoal{
        Security property 13: Only message modifications referenced in one of the \gls{sepp} operator's modification policies shall be possible. (c.f. \cite{3gpp.33.501}, p. 127)
    }
