\lstdefinestyle{proverif}{
    ...
    showtabs=false,
    tabsize=2,
    morekeywords={let, in, if, then, else, event, inj, new, out, fun, reduc, forall, insert, get, table, type, free, const, process, sync},
    comment=[l]{(*}
}
...
\begin{lstlisting}[caption={Declaration of local SEPP storage using tables},label={lst:tables},firstnumber=45]
table storeSeppA(
...
\begin{lstlisting}[caption={Definition of custom constructors and destructors},label={lst:destructors},firstnumber=142]
...
\begin{lstlisting}[caption={Definition of the sending N32-c handshake process},label={lst:n32c-handshake-send},firstnumber=434]
...
\begin{lstlisting}[caption={Definition of the receiving N32-c handshake process},label={lst:n32c-handshake-recv},firstnumber=488]
...
\begin{lstlisting}[caption={Definition of the receiving error signaling process},label={lst:n32c-error-recv},firstnumber=560]
...
\begin{lstlisting}[caption={Definition of the requesting NF process},label={lst:nf-request},firstnumber=738]
...
\begin{lstlisting}[caption={Definition of the sending IPX process},label={lst:ipx-send},firstnumber=1088]
...
\begin{lstlisting}[caption={Definition of the receiving IPX process},label={lst:ipx-recv},firstnumber=1129]
...
\begin{lstlisting}[caption={Definition of the main process},label={lst:main-proc},firstnumber=1508]
    (* process execution *)
    (
