\begin{abstract}
    ...
    Although no concrete attacks substantiate from the formal verification, it is shown that the \gls{3gpp} specification contains several inconsistencies and, most notably, a lack of clarity about what the protocol is supposed to achieve.
